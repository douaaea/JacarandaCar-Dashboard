                                            ...
                                            <div class="col-lg-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" id="prenom" name="modelMarque"
                                                        ...
                                                        placeholder="Entrer le modèle à ajouter">
                                                    @error('modelMarque')
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form method="GET" class="d-flex" action="{{ route('modele.search') }}">
                                    ...
                                    <table id="alternative-page-datatable"
                                        ...
                                        <tbody>
                                            @foreach ($modeles as $model)
                                                <tr>
                                                    <td>{{ $model->modelMarque }}</td>
                                                    <td>{{ $model->marqueVoiture }}</td>
                                                    <td>
                                                        <div class="d-flex flex-wrap gap-2">
                                                            <a class="btn btn-warning"
                                                                href="{{ route('modele.edit', $model->idModel) }}"
                                                                role="button">Modifier</a>
                                                            <form id="delete-form-{{ $model->idModel }}"
                                                                action="{{ route('modele.destroy', $model->idModel) }}"
                                                                method="POST" style="display: none;">
                                                                @csrf
                                                                @method('DELETE')
                                                            </form>
                                                            <button class="btn btn-danger"
                                                                onclick="confirmDelete(event, {{ $model->idModel }})">Retirer</button>
